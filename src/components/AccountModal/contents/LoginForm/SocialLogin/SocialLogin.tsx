...
const socialBtns = [
  {
    ...
    button: <GoogleBtn />,
    name: '구글',
    url: 'http://api.its-movietime.com/oauth2/authorization/google',
  },
  {
    type: 'naver',
    button: <NaverBtn />,
    name: '네이버',
    url: 'http://api.its-movietime.com/oauth2/authorization/naver',
  },
  {
    type: 'kakao',
    button: <KakaoBtn />,
    name: '카카오',
    url: 'http://api.its-movietime.com/oauth2/authorization/kakao',
  },
];
